...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "-created"], name="fingerprint_user_id_b99b01_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="usersession",
            constraint=models.UniqueConstraint(
                fields=("session_key", "user"), name="unique_user_session"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="requestfingerprint",
            index=models.Index(
                fields=["ip", "-created"], name="fingerprint_ip_56a800_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="requestfingerprint",
            index=models.Index(
                fields=["user_agent", "-created"], name="fingerprint_user_ag_5d70f2_idx"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="browserfingerprint",
            index=models.Index(
                fields=["visitor_id", "-created"], name="fingerprint_visitor_af9597_idx"
            ),
        ),
    ]
